...
\begin{minipage}{\listingwidth}
\begin{lstlisting}[language=ada,label=lst:await_event, caption=\texttt{Await\_Event} entry
    of the \texttt{TType} thread type's synchronizer.]
...
\begin{minipage}{0.45\linewidth}
\lstset{language=aadl}
\begin{lstlisting}[label=lst:cs_data, caption=AADL data components.] 
