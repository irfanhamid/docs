...
d'un sous-système utilis\'es comme un bloque hierarchique dans un
système englobant. Les ports d'entr\'ees et sorties deviennent les parametres
...
\item{G\'en\'eration du code synchrone ainsi qu'asynchrone, ç-à-d,
  cibl\'e \`a un RTOS;}
...
\emph{signaux}---\'evennements asynchrones---aux autres classes
...
\item{Le contr\^ole asynchrone est interdit, ç-à-d, des t\^aches ne
  ...
  d'autres t\^aches;}
\item{Les objets proteg\'es---objets de synchronisation---doivent
...
prot\'eg\'es. Ceux sont similaires aux objets synchronisés en
...
\item[T\^ache sporadique:]{Transform\'ee en t\^ache Ada avec des
  ...
  que l'on appel un \emph{synchroniseur} est aussi g\'en\'er\'e sur
...
\item[Event (data) port:]{Transform\'e \`a un type dans
  ...
  d'\'evennement dans le synchroniseur de la t\^ache cible au cas de
  port de sorti;}
...
outils pertinent aux syst\`emes temps-r\'eel asynchrones
g\'en\'eralistes.
...
%%  LocalWords:  l'ordinateurisation
