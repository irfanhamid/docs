...
\caption[Suboptimal implementation of the deterministic data transfer
  protocol.]{A suboptimal implementation. Left: Data flow from a fast
...
\caption{The example system with two periodic and one sporadic
  thread.}
...
\caption{The labelled transition system generated by CADP from the
  example.}
\label{fig:lts_ex1}
\end{figure}
