...
of the entry is not atomic with the \texttt{Clock}
instruction.
...
$t_2$ & $\tau_1$ sleeps after its processing, $\tau_2$ resumed
...
\caption[Features and subcomponents possible for a \texttt{subprogram}
  component.]{Features and subcomponents possible for a
  \texttt{subprogram} component. Note, it cannot contain any
  subcomponents.}
...
be declared in a component type or implementation within \kw{annex
}\texttt{annex\_name \textbf{\{**} annex text \textbf{**\}}}.
